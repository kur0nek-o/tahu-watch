...
const buttonClass = computed(() =>
  [
    'cursor-pointer inline-flex justify-center items-center border border-transparent bg-red-600 font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2',
